    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert text-center" style="background-color:#99decc" role="alert">
                <h3> <div style="font-family:maiandra gd; font-weight:bold;" >Update Desain Twibbon  </div></h3>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card">
                ...
                @endif  
                    <form method="post" action="/twibbon/update/{{ $twibbon->id }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
